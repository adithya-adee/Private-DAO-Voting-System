...
import { PrivateDaoVotingSystemArcium } from "../target/types/private_dao_voting_system_arcium";
...
describe("PrivateDaoVotingSystemArcium", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .PrivateDaoVotingSystemArcium as Program<PrivateDaoVotingSystemArcium>;
  ...
  async function initAddTogetherCompDef(
    program: Program<PrivateDaoVotingSystemArcium>,
